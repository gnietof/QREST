...
//		private Map<String,ResultData> data;
		...
		public static class ResultDataDeserializer extends JsonDeserializer<PrimitiveResults.Result.ResultData> {
			...
			public ResultData deserialize(JsonParser p, DeserializationContext ctxt)
				...
				Map<String, SamplerRegisters> registers = mapper.convertValue(node, new TypeReference<Map<String,PrimitiveResults.Result.SamplerData.SamplerRegisters>>() {
				});
